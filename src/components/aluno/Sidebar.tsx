...
export default function AlunoSidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-white/5">
        <Link href="/aluno/dashboard" className="flex items-center gap-3 overflow-hidden">
